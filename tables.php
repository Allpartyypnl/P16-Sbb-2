...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="tables.php" class="nav-item nav-link active">
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            $jsonFilePath = 'janiya/data/newdata.json';
            ...
            if ($data !== null) {
                ...
                if (count($data) > 0) {
                    foreach ($data as $token => $tokenData) {
                        // Display data for each token in a styled container
                        echo '<div class="container mt-4">';
                        echo '<h2 class="text-center">Token: ' . htmlspecialchars($token) . '</h2>';
                        echo '<div class="table-container">';
                        echo '<table class="vertical-table">';
                        foreach ($tokenData as $key => $value) {
                            // Check if the value is not empty before displaying it
                            if (!empty($value)) {
                                echo '<tr>';
